...
def custom_exception_handler(exc, context):
    ...
    if response is None:
        # DRF didn't handle it — unhandled exception (DB error, etc.).
        # Log the full traceback so it lands in our log stream, but never
        # leak internal error/schema/view details to the client.
