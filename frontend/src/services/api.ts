...
export const tenantApi = {
  ...
  exportStatement: (id: number, params?: { period_start?: string; period_end?: string; fmt?: 'csv' | 'pdf' }) =>
...
export const subsidiaryApi = {
  ...
  exportStatement: (accountId: number, params: { period_start: string; period_end: string; view?: string; format?: string; currency?: string }) =>
