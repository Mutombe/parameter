    ...
    printWindow.document.write(`
      ...
      <head>
        ...
        <style>
          ...
          .total { background: #111827; color: white; padding: 20px; border-radius: 8px; text-align: center; margin-top: 20px; }
          .total p { font-size: 32px; font-weight: bold; margin: 5px 0 0; }
      ...
      <body>
        ...
        <div class="info">
          <div>
            ...
            ${invoice?.unit_name ? `<p><strong>Unit:</strong> ${invoice.unit_name}</p>` : ''}
          </div>
          <div style="text-align:right">
            <p><strong>Date:</strong> ${invoice?.date ? formatDate(invoice.date) : '-'}</p>
            <p><strong>Due:</strong> ${invoice?.due_date ? formatDate(invoice.due_date) : '-'}</p>
