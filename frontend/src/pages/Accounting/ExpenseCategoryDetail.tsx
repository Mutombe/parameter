  ...
  return (
    <div className="space-y-6">
      <nav className="flex items-center gap-2 text-sm text-gray-500">
        ...
        <span>/</span>
        <button onClick={() => navigate('/dashboard/expense-categories')} className="hover:text-gray-900">Expense Categories</button>
        <span>/</span>
      ...
      <button onClick={() => navigate('/dashboard/expense-categories')} className="inline-flex items-center gap-1.5 text-sm text-gray-500 hover:text-gray-900">
        <ArrowLeft className="w-4 h-4" /> Back to Expense Categories
      </button>
