    ...
    <div className="space-y-6">
      ...
      {isLoading ? (
        <div className="card overflow-hidden animate-pulse">
          {/* Table header */}
          <div className="grid grid-cols-[120px_1fr_2fr_1fr_140px] gap-4 px-4 py-3 bg-gray-50 border-b border-gray-200">
          ...
          {/* Table rows */}
          {[...Array(8)].map((_, i) => (
            <div key={i} className="grid grid-cols-[120px_1fr_2fr_1fr_140px] gap-4 px-4 py-3.5 border-b border-gray-100 items-center">
