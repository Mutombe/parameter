          ...
          <div className="bg-white rounded-xl border border-gray-200 overflow-hidden">
            ...
            <div className="p-6">
              {loadingSubAccounts ? (
                ...
                (() => {
                  // Group chips by currency so each currency's accounts wrap
                  // onto its own row group — 6 fit per row on xl+ at the
                  // chosen chip width (≈148px + gap). Mirrors PropertyDetail.
                  const accounts = normalizeList(subAccountsData)
